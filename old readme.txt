...
⚙️ Set Test Mode: Ensure enableTestMode: true in src/config/roundtable-config.ts
🌐 Open Browser: Navigate to http://localhost:3000
🎤 Test Speech Input: Click microphone button, speak a response, see real-time transcription
🤖 Try AI Analysis: Submit responses, trigger different AI analysis types (insights, synthesis, follow-ups)
📋 Generate Summary: Click "Generate Summary" after multiple responses, test narrative summaries
📄 Test Export: Export summary as PDF (print) and CSV download
🧪 Testing & Development
Test Mode Features
...
⚙️ Configure Strategic Questions: Edit src/config/roundtable-config.ts for your specific AI transformation topic
🧪 Test Complete Workflow: Run in test mode to verify speech-to-text, AI insights, and summary generation
🔒 Switch to Live Mode: Set enableTestMode: false and verify OpenAI API key
🌐 Prepare Environment: Test microphone permissions, check browser compatibility
📊 Monitor Dashboard: Verify logging is active, rate limits configured
...
🎯 Strategic Facilitation: Build on AI insights with human judgment and experience
📝 Session Memory: AI maintains context across all questions for sophisticated analysis
Session Conclusion (10 minutes)
📋 Generate Comprehensive Summary: Click "Generate Summary" for executive-ready output
...
Post-Session
Export Results: JSON file with all responses and insights
Follow-up: Use insights for action planning
Cost Review: Check OpenAI API usage costs
Session Notes: Document what worked well for next time
📊 Cost Management
...
📈 OpenAI Dashboard: Monitor usage at platform.openai.com
📊 Enhanced Application Logs: Track API calls, token usage, and cost estimates
⚙️ Configurable Limits: Adjust rate limits and token caps in config file
🚨 Cost Alerts: Set up usage alerts in OpenAI dashboard
📊 ROI Tracking: Professional summaries justify strategic session investment
...
🧪 Test Mode First: Always verify functionality in test mode
📊 Check Enhanced Logs: Browser console + server terminal output
⚙️ Verify Configuration: Double-check all config files and environment variables
🌐 Test Browser Compatibility: Try different browsers for speech/compatibility issues
📁 Check Dependencies: Ensure all packages installed and up to date
...
Repository: GitHub - Enterprise AI Roundtable Co-Facilitator Agent
...
End-to-End Testing: Comprehensive testing of summary generation and export functionality
Accessibility Refinements: ARIA compliance and keyboard navigation (deferred per user preference)
Performance Optimization: Further API response time improvements
Advanced Analytics: Session insights and facilitator performance metrics