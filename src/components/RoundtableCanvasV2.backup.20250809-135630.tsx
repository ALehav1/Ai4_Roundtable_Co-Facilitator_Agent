...
const RoundtableCanvasV2: React.FC = () => {
  ...
  const [activeAITab, setActiveAITab] = useState<'all' | 'insights' | 'followup' | 'synthesis' | 'executive'>('insights');
                ...
                <div className="ai-panel mt-6 pt-6 border-t p-6 bg-white rounded-lg shadow-sm">
                  <div className="ai-header">
                    ...
                    {sessionContext.aiInsights && sessionContext.aiInsights.length >= 1 && (
                      <div className="mb-4">
                        <button
                          data-testid="ai-exec-summary-button"
                        ...
                        return (
                          <div className="text-center py-12">
                            ...
                            <p className="text-gray-500">
                              No {activeAITab} available yet. Start your session to see AI-generated content here.
                            </p>
                          </div>
                        );
                      }
