...
Synthesize ONLY what's in the transcript in this exact JSON format:
{
  ...
  "speakerCount": number of distinct speakers identified or 0
    ...
    case 'followup':
      return baseInstruction + `
Suggest follow-up questions based ONLY on the transcript in this exact JSON format:
{
  "questions": ["Question 1 based on actual content", "Question 2"] or [],
  "confidence": 0.0 to 1.0,
  "type": "followup",
  "rationale": "Why these questions (based on transcript)" or "No content to generate questions from"
}`;
